...
/**
  ...
  * @notice The DrawCalculator calculates a user's prize by matching a winning random number against
            ...
            of share held. Prize payouts are divided into multiple tiers: grand prize, second place, etc...
...
contract DrawCalculator is IDrawCalculator {
    ...
    /// @notice share associated with DrawCalculator
    IShare public immutable share;
    ...
    /// @param _share share associated with this DrawCalculator
    ...
    constructor(
        ...
        require(address(_share) != address(0), "DrawCalc/share-not-zero");
        ...
        emit Deployed(_share, _drawBuffer, _prizeDistributionBuffer);
    }
    ...
    function _getNormalizedBalancesAt(
        ...
        uint256[] memory balances = share.getAverageBalancesBetween(
            _user,
            _timestampsWithStartCutoffTimes,
            _timestampsWithEndCutoffTimes
        );

        uint256[] memory totalSupplies = share.getAverageTotalSuppliesBetween(
            _timestampsWithStartCutoffTimes,
            _timestampsWithEndCutoffTimes
        );
